...
internal class SyncReadDbOnProductVariantRemoved : DomainEventHandler<ProductVariantRemoved>
{
    private readonly ICatalogMongoContext _catalogMongoContext;
    private readonly IProductRepository _productRepository;
    private readonly ILogger<SyncReadDbOnProductVariantRemoved> _logger;

    public SyncReadDbOnProductVariantRemoved(
        ICatalogMongoContext catalogMongoContext,
        IProductRepository productRepository,
        ILogger<SyncReadDbOnProductVariantRemoved> logger)
    {
    ...
    public override async Task Handle(ProductVariantRemoved domainEvent, CancellationToken cancellationToken = default)
    {
