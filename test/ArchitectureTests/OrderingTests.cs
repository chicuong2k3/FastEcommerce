...
public class OrderingTests
{
    ...
    private readonly Assembly CoreAssembly = typeof(Ordering.Core.AssemblyInfo).Assembly;
    private readonly Assembly ApplicationAssembly = typeof(AssemblyInfo).Assembly;
    private readonly Assembly ContractsAssembly = typeof(Ordering.Contracts.AssemblyInfo).Assembly;
